  ...
  return (function (e) {
    ...
    function (e, t, n) {
      ...
      var r = n(88),
        ...
        c = function (e, t, n, r) {
          (!(t in e) || (s(r) && r())) &&
            (l ? u(e, t, { configurable: !0, enumerable: !1, value: n, writable: !0 }) : (e[t] = n));
        },
        f = function (e, t) {
...
*/
      ...
      (i.prototype.Q = function (e) {
        ...
        (i.prototype.bind = function () {
          var e = this,
            ...
            c = function (e) {
              ...
              for (var r in a)
                a.hasOwnProperty(r) &&
                  !!d.default.build(r) &&
                  n.push('<i title="' + r + '" >' + d.default.build(r) + '</i>');
              t.html(n.join('')),
                (s = !0),
          ...
          (e.$emoji = {
            ...
            (e.$preview = {
              show: function () {
                return (
                  O
                    ? (e.$emoji.hide(), i.addClass('actived'), n.html((0, E.default)(O)).show(), R())
                    : e.$preview.hide(),
                  e.$preview
                );
              },
          ...
          var f = function (t) {
            var r = t.val() || '';
            r || e.$preview.hide(),
              O != r && ((O = r), i.hasClass('actived') > -1 && O != n.html() && n.html((0, E.default)(O)), R());
          };
                    ...
                    e.cfg.enableQQ &&
                      ...
                      (isNaN(n.val())
                        ? A.default.store.get(h.QQCacheKey) &&
                          ...
                          (A.default.store.remove(h.QQCacheKey), (S.nick = n.val()), (S.mail = ''), (S.QQAvatar = ''))
            ...
            T = function (t, n, r) {
              ...
              var s = t.get('link')
                  ? /^https?\:\/\//.test(t.get('link'))
                    ...
                    : 'http://' + t.get('link')
                  : '',
                l = A.default.escape((0, C.default)(t.get('nick').substring(0, 20))),
                c = s
                  ? '<a class="vnick" rel="nofollow" href="' + j(s) + '" target="_blank" >' + l + '</a>'
                  : '<span class="vnick">' + l + '</span>',
                f = $.hide
                  ? ''
                  : e.cfg.enableQQ && t.get('QQAvatar')
                  ? (0, C.default)(
                      '<img class="vimg" src="' + j(t.get('QQAvatar')) + '" referrerPolicy="no-referrer"/>'
                    )
                  : '<img class="vimg" src="' + ($.cdn + (0, u.default)(t.get('mail')) + $.params) + '">',
                p =
                  f +
            ...
            z = function (t, n) {
              t.on('click', function (r) {
                ...
                (0, A.default)('.vreply-wrapper[data-self-id="' + o + '"]')
                  ...
                  .find('.cancel-reply')
                  .show(),
                  (I = { at: A.default.escape(u) + ' ', rid: i, pid: o, rmail: n.get('mail') }),
            ...
            U = function () {
              ...
              n.setACL(N()),
                n
                  ...
                  .then(function (t) {
                    'Anonymous' != S.nick &&
                      A.default.store.set(h.MetaCacheKey, { nick: S.nick, link: S.link, mail: S.mail });
                    var n = e.$el.find('.vnum');
                    try {
                      I.rid
                        ? T(t, (0, A.default)('.vquote[data-self-id="' + I.rid + '"]'), !0)
                        : (Number(n.text())
      ...
      var r = n(3),
        ...
        a = function (e, t) {
          ...
          n && n.qq == e
            ? t && t(n)
            : i.default
                .ajax({ url: '//valine.api.ioliu.cn/getqqinfo', method: 'POST', body: { qq: e } })
                .then(function (e) {
                  e.json().then(function (e) {
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        var n;
        if (
          (r && (Symbol.toPrimitive ? (n = l(e, Symbol.toPrimitive)) : u(e) && (n = Symbol.prototype.valueOf)),
          void 0 !== n)
        ) {
          var o = n.call(e, t);
          if (i(o)) return o;
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        for (
          ...
          s.push('$' + l);
        if (
          ((n = Function('binder', 'return function (' + s.join(',') + '){ return binder.apply(this,arguments); }')(a)),
          t.prototype)
        ) {
          var c = function () {};
            ...
            return (
              ...
              (n.autolink = function (e, t) {
                ...
                if (n) {
                  ...
                  return (
                    '@' === n[2]
                      ? ((r = s(this.options.mangle ? t(n[1]) : n[1])), (i = 'mailto:' + r))
                      : ((r = s(n[1])), (i = r)),
        ...
        var U = (function () {
            function t(t) {
              ...
              this.options.pedantic
                ...
                : this.options.gfm &&
                  ((n.block = L.gfm), this.options.breaks ? (n.inline = N.breaks) : (n.inline = N.gfm)),
...
*/
    ...
    function (e, t, n) {
      ...
      var T = 'function' == typeof Map && Map.prototype,
        ...
        fe =
          'function' == typeof Symbol && Symbol.toStringTag && (typeof Symbol.toStringTag === ce ? 'object' : 'symbol')
            ? Symbol.toStringTag
            : null,
      ...
      e.exports = function e(t, n, F, T) {
        ...
        if ('function' == typeof t) {
          var H = m(t),
            Z = j(t, I);
          return (
            '[Function' + (H ? ': ' + H : ' (anonymous)') + ']' + (Z.length > 0 ? ' { ' + ie.call(Z, ', ') + ' }' : '')
          );
        }
        if (d(t)) {
